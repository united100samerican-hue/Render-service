...
class AudioService:
    ...
    async def _resolve(
        ...
        if st in {
            ...
            try:
                ...
                # A signed YouTube media URL may expire or require the exact
                # headers generated by yt-dlp. Force a fresh extraction once
                # instead of returning a stale URL from the short cache.
    ...
    async def _materialize_url(
        ...
        saved_headers = result.get("http_headers")
